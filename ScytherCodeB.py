...
const MUL:Function;
const GEN:Function; 
const BFIu,BFGu,Dc,Bc,T1,T2,IDc,BSr,Rbs,Rc-as,Hc,T3,T4,PWu,PWu',Ec,RANu,Ku,Lbs,T5,Rbs-u,RAN,CBc,BIDr,IDu,Ras,Tbc,Obc,Nbc,Tbc,Tcb,Rbc,Sc,Rcb,SKb-c,C1,XSs,ZSs,R1,SRs,SIDp,CIDq,SKe-v,SKbs-as;      
const ADD:Function;      
...
macro SKb-c'=H(IDc,BIDr,Rbc,Rcb);
      #Base station and cloud session key
match(Pcb',Pcb);
      #verify by matching the constraints
